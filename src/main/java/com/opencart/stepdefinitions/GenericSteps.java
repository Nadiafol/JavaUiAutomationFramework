...
public class GenericSteps {
    ...
    public void theFollowingErrorMessagesAreDisplayed(List<String> errorMessagesList) throws InterruptedException {
        for (int i = 0; i < errorMessagesList.size(); i++) {
            ...
            boolean isErrorMessageNumberIisDisplayed = errorMessageElement.isDisplayed();
            Assertions.assertTrue(isErrorMessageNumberIisDisplayed, "The error message" + errorMessagesList.get(i) + "is displayed");
        }
    }
